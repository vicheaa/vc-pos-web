...
export const Route = createFileRoute("/_app/orders_/$id")({
  component: OrderDetailsPage,
});

function OrderDetailsContent() {
  const { id } = useParams({ from: "/_app/orders_/$id" });
  ...
  return (
    <div className="space-y-4 bg-white dark:bg-background p-4 rounded-md">
      <div className="flex items-center justify-between">
        ...
        <div onClick={() => window.history.back()} className="flex items-center hover:cursor-pointer hover:bg-accent hover:text-accent-foreground rounded-md px-2 py-1 gap-2">
          <ArrowLeft size={18} />
          <p>Back</p>
        </div>
      </div>
